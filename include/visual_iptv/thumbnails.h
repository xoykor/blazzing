...
typedef vip_status_t (*vip_thumbnail_capture_fn)(const vip_thumbnail_request_t *request, char **path_out,
                                                 vip_error_t *error, void *userdata);
typedef void (*vip_thumbnail_ready_fn)(const vip_thumbnail_request_t *request, vip_status_t status,
